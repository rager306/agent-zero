...
def get_default_settings() -> Settings:
    return Settings(
        ...
        chat_model_api_base="https://api.minimax.io/v1",
        chat_model_kwargs={"temperature": 1},
        chat_model_ctx_length=100000,
        chat_model_ctx_history=0.7,
        chat_model_vision=False,  # MiniMax does not support vision input
        chat_model_rl_requests=0,
        chat_model_rl_input=0,
        chat_model_rl_output=0,
        util_model_provider="other",
        util_model_name="MiniMax-M2.1-lightning",
        util_model_api_base="https://api.minimax.io/v1",
        ...
        browser_model_name="MiniMax-M2.1-lightning",
        browser_model_api_base="https://api.minimax.io/v1",
        browser_model_vision=False,  # MiniMax does not support vision input
